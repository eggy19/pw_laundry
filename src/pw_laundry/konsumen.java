...
public class konsumen extends javax.swing.JInternalFrame {
    ...
    Object[][] tb;
    String [] judul={
        "Kode Konsumen", "Nama", "Alamat", "NO HP"
    };
    ...
    private void initComponents() {
        ...
        cmb_cari.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Cari Berdasarkan:", "kode", "nama" }));
        ...
        jScrollPane3.setViewportView(tbl_konsumen);
    ...
    private void tbl_konsumenMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_konsumenMouseClicked
        ...
        int i = tbl_konsumen.getSelectedRow();
        if(i == -1){
            return;
        }
    ...
    private void ubah(){
        try {
            String sql ="UPDATE konsumen SET"                    
                    + " nm_konsumen='"   + txt_nama.getText()
                    + "', alamat='"     + txt_alamat.getText()
                    + "', telp='"        + txt_no.getText()
                    + "' WHERE kd_konsumen= '"       + txt_kd.getText() + "'";
    ...
    private void hapus(){
        try {
            String sql = "DELETE FROM konsumen WHERE kd_konsumen='" + txt_kd.getText() + "'";
            stat = kon.createStatement();
            stat.executeUpdate(sql);
    ...
    private void kd_oto(){
        try {
            String sql = "SELECT MAX(right(kd_konsumen,3)) FROM konsumen";
            
            stat=kon.createStatement();
            res = stat.executeQuery(sql);
            while(res.next()){
                int a = res.getInt(1);
                txt_kd.setText("K00" + Integer.toString(a+1));
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, e);
        }
    ...
    private void cari(){
        try {
            ...
            if(cmb_cari.getSelectedIndex()==0){
                ...
                if(cmb_cari.getSelectedItem()=="kode"){
                    cari_ber = "kd_konsumen";
                }else if(cmb_cari.getSelectedItem()=="nama"){
                    cari_ber = "nm_konsumen";
                }
                ...
                while(res.next()){
                    ...
                    tb[x][0]=res.getString("kd_konsumen");
                    tb[x][1]=res.getString("nm_konsumen");   
                    tb[x][2]=res.getString("alamat");
                    tb[x][3]=res.getString("telp");
                    x++;
                }
                tbl_konsumen.setModel(new DefaultTableModel(tb,judul));
        } catch (Exception e) {
